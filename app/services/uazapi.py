...
async def send_presence(number: str, presence: str = "composing") -> None:
    ...
    {number, presence}. NAO usar /chat/presence nem /send/presence (405).
    Presenca e efemera — chamar antes de cada balao para o usuario ver
    "digitando..." enquanto a IA gera/responde.
    """
