...
async def append_chat_history(phone: str, role: str, text: str) -> None:
    ...
    await r.ltrim(keys.history_key(phone), -10, -1)  # manter ultimas 10 msgs
...
async def reset_lead_state(phone: str) -> None:
    ...
    Inclui: histórico, buffer, bloqueio humano, flag de alerta, mute em lote,
    followup ativo e o hash do lead."""
    r = await get_redis()
    await r.delete(
