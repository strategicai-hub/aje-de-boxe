...
# Neste projeto os defaults do config.py sao especificos de AJE (WEBHOOK_PATH=/ajeboxe,
# RABBITMQ_QUEUE=ajeboxe). Sobrescrevemos aqui para alinhar com PROJECT_SLUG=testslug.
os.environ.setdefault("WEBHOOK_PATH", "/testslug")
os.environ.setdefault("RABBITMQ_QUEUE", "testslug")
os.environ.setdefault("UAZAPI_INSTANCE", "testslug")
